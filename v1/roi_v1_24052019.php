...
<html>
        ...
        <script>
            ...
            app.controller('myCtrl', function ($scope) {
                ...
                $scope.HVAssetLossReduction = function () {
                    ...
                    $scope.hv_avg_annual_asset_loss_per_year_1_per = ($scope.hv_total_asset_value * 0.01);
                ...
                $scope.AssetLossReduction = function () {
                    ...
                    $scope.lr_avg_annual_asset_loss_per_year_1_per = ($scope.lr_total_asset_value * 0.01);
                    $scope.AnnualLostAssetReplacement();
                    $scope.CostReductionMinDeliveryValue();
                };
    ...
    <body>
        ...
        if (isset($_POST['roi_submit'])) {
            ...
            $_POST['hv_avg_annual_asset_loss_per_year_1_per'] = round(($_POST['hv_total_asset_value'] * 0.01), 2);
            ...
            $_POST['lr_avg_annual_asset_loss_per_year_1_per'] = round(($_POST['lr_total_asset_value'] * 0.01), 2);
        ...
        <div class="mp-pusher" id="mp-pusher">
            ...
            <div class="roi-banner"> 
                ...
                <div class="banner-content"> 
                    ...
                    <p> Learn more about our Healthcare assets</p> 
                </div>
            </div> 
