    ...
    <head>
        ...
        <style>
            * {
            ...
            .roi-banner{
                background:url('./img/roi-banner.jpg') no-repeat left center;
        ...
        <script>
            $(document).ready(function () {
                ...
                $.validator.addMethod('nofreeemail', function (value) {
                    return /^([\w-.]+@(?!gmail\.com)(?!yahoo\.com)(?!hotmail\.com)(?!aol.com)(?!abc.com)(?!xyz.com)(?!pqr.com)(?!rediffmail.com)(?!yahoo.co.in)(?!live.com)(?!outlook.com)(?!me.com)(?!msn.com)(?!ymail.com)([\w-]+.)+[\w-]{2,4})?$/.test(value);
                }, 'Please enter your business email, we do not accept Gmail, Yahoo, Hotmail, etc.');
...
// validate signup form on keyup and submit
        ...
        <script>
            ...
            app.controller('myCtrl', function ($scope) {
                ...
                $scope.AssetUtilization = function () {
                    $scope.au_total_asset = $scope.hv_total_asset + $scope.lr_total_asset;
                    ...
                    //$scope.au_daily_asset_revenue_year_1_per = $scope.au_daily_asset_value * 0.01 * 365;
                ...
                $scope.AnnualLostAssetReplacement = function () {
                    ...
                    //$scope.alar_total_lost_asset = ($scope.hv_total_asset + $scope.lr_total_asset) * 0.01;
                    $scope.alar_total_lost_asset = ($scope.hv_total_asset * ($scope.hv_per_avg_asset_loss_per_year / 100)) + ($scope.lr_total_asset * ($scope.lr_per_avg_asset_loss_per_year / 100));
                ...
                $scope.CostReductionMinDeliveryValue = function () {
                    /*
                     $scope.hv_loss_reduction = ($scope.hv_total_asset_value * 0.01);
                     $scope.avg_asset_loss_reduction = ($scope.lr_total_asset_value * 0.01);
                     */
                    $scope.hv_loss_reduction = ($scope.hv_avg_annual_asset_loss_per_year_1_per);
                    $scope.avg_asset_loss_reduction = ($scope.lr_avg_annual_asset_loss_per_year_1_per);
                    $scope.avg_replacement_lost_asset = ($scope.alar_replacement_cost_year * 0.1);
                    $scope.reduction_staff_search_time = (0.5 * $scope.stlp_hrs_wasted_annually * 30);
                    $scope.increase_asset_utilization = $scope.au_daily_asset_revenue_year_1_per; //($scope.au_daily_asset_revenue_year * 0.01);
                    $scope.decrease_lost_asset_revenue = ($scope.alarl_asset_revenue_loss_year * 0.01);
    ...
    <body>
        ...
        if (isset($_POST['roi_submit'])) {
            ...
            $_POST['au_total_asset'] = $_POST['hv_total_asset'] + $_POST['lr_total_asset'];
            ...
            //$_POST['au_daily_asset_revenue_year_1_per'] = round(($_POST['au_daily_asset_value'] * 0.01 * 365), 2);
            ...
            //$_POST['alar_total_lost_asset'] = round((($_POST['hv_total_asset'] + $_POST['lr_total_asset']) * 0.01), 2);            
            $_POST['alar_total_lost_asset'] = round((($_POST['hv_total_asset'] * ($_POST['hv_per_avg_asset_loss_per_year'] / 100)) + ($_POST['lr_total_asset'] * ($_POST['lr_per_avg_asset_loss_per_year'] / 100))), 2);
            ...
            /*
              $_POST['hv_loss_reduction'] = round(($_POST['hv_total_asset_value'] * 0.01), 2);
              $_POST['avg_asset_loss_reduction'] = round(($_POST['lr_avg_annual_asset_loss_per_year'] * 0.01), 2);
             * 
             */
            $_POST['hv_loss_reduction'] = round(($_POST['hv_avg_annual_asset_loss_per_year_1_per']), 2);
            $_POST['avg_asset_loss_reduction'] = round(($_POST['lr_avg_annual_asset_loss_per_year_1_per']), 2);
            $_POST['avg_replacement_lost_asset'] = round(($_POST['alar_replacement_cost_year'] * 0.1), 2);
            $_POST['reduction_staff_search_time'] = round((0.5 * $_POST['stlp_hrs_wasted_annually'] * 30), 2);
            $_POST['increase_asset_utilization'] = round($_POST['au_daily_asset_revenue_year_1_per'], 2); //round(($_POST['au_daily_asset_revenue_year'] * 0.01), 2);
            $_POST['decrease_lost_asset_revenue'] = round(($_POST['alarl_asset_revenue_loss_year'] * 0.01), 2);
...
// Generate PDF
                ...
                // file path
                $file_path = 'https://www.pycube.com/show_file.php?' . base64_encode(base64_encode("path=roi_files" . "&file=" . $filename));
                ...
                curl_setopt($email_curl, CURLOPT_CONNECTTIMEOUT, 0);
                $email_content = curl_exec($email_curl);
                curl_close($email_curl);
				
				
                //$message = $mail_head . '<table width="100%" border="0" cellspacing="0" cellpadding="0"><tr><td><p>Dear ' . trim($full_name) . ',</p><p>Thank you for contacting with Pycube.</p><p>You have requested for Hospital ROI View w Utilization WVH DJ, please <a href="' . $url . '">click here</a> for more details.</p></td></tr></table>' . $mail_footer;
                $message = $mail_head . '<table width="100%" border="0" cellspacing="0" cellpadding="0"><tr><td><p>Dear ' . trim($full_name) . ',</p><p>Thank you for contacting with Pycube.</p><p>You have requested for Hospital ROI view utilization, Please <a href="' . $url . '">click here</a> for more details.</p></td></tr></table>' . $mail_footer;
...
// More headers
		...
		$headers .= 'Reply-To: <steve.l@pycube.com>' . "\r\n";
                //$headers .= 'Cc: amanda.atrash@pycube.com' . "\r\n";
                $headers .= 'Cc: steve.l@pycube.com, vinod@pycube.com, srinivas.k@pycube.com' . "\r\n"; 
                
                $mailto = mysqli_real_escape_string($connection, $_POST['email']);
                mail($mailto, "Pycube Asset Management ROI & TCO Value Analyzer", $email_content, $headers);
// Send mail end
                $res_message = 'Thank you for requesting the Pycube TCO / ROI Analyzer with your data calculations. You will be receiving an Email with your report link in the next few moments . Please be sure to check you spam/Junk folder if you do not find it in your INBOX.';
            } else {
        ...
        <div class="mp-pusher" id="mp-pusher">
            <header class="bg_header">
                <div class="container-fluid"> 
                    <div class="row">
                        <div class="col col-md-3 logo"> <a href="roi.php">  <img src="img/logo.png" alt="PyCube Asset Management"/>  </a>  </div>
            ...
            <div class="roi-banner"> 
                ...
                <div class="banner-content"> 
                    <h2>  PYCUBE ASSET MANAGEMENT </h2> 
                    <p> TCO/ROI Value Profile Analyzer</p> 
                </div>
            </div> 
            ...
            <!-- Header End -->
            <div class="container-fluid pt40"  ng-app="myApp" ng-controller="myCtrl">
                <?php if ($msg != '' && 1 == 2) { ?>
                    <div class="row">
                        <div class="col-md-12">
                            <?php echo $msg; ?>
                ...
                <?php } ?>
                <input type="hidden" name="res_message" value="<?php echo $res_message; ?>" id="res_message" />
                <form action="" name="roi_form" id="roi_form" method="post"  class="form-horizontal">
                        ...
                        <div class="col-md-12">
                            <div class="row row-eq-height">
                                <div class="col-md-4 same_box">
                                    <ul class="price">
                                        <li class="header2"> <strong>High Value Asset Loss Reduction*</strong>
                                        </li>
                                        ...
                                        <li  class=""> 
                                            <div class="form-group m-0 row">
                                                ...
                                                <div class="col-sm-6 sub-input">
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text" style="padding: 6px;" id="basic-addon1">$</span>
                                                        </div>
                                                        <input class="form-control" type="number" placeholder="0.00" name="hv_asset_avg_cost" id="hv_asset_avg_cost" required="true" ng-model="hv_asset_avg_cost" ng-change="HVAssetLossReduction()"/> 
                                                    </div>
                                                </div>
                                            </div>                                
                                        </li>
                                            ...
                                            <div class="form-group m-0 row">
                                                ...
                                                <div class="col-sm-6 sub-input"> 
                                                    <div class="input-group">
                                                        ...
                                                        <input class="form-control" type="number" name="hv_total_asset_value" id="hv_total_asset_value" ng-model="hv_total_asset_value" placeholder="0.00"  disabled />  
                                                    </div>
                                                </div> 
                                            </div>
                                        </li>
                                            ...
                                            <div class="form-group m-0 row">
                                                ...
                                                <div class="col-sm-6 sub-input"> 
                                                    <div class="input-group">
                                                        ...
                                                        <input class="form-control" type="number" name="hv_avg_annual_asset_loss_per_year" id="hv_avg_annual_asset_loss_per_year" ng-model="hv_avg_annual_asset_loss_per_year" placeholder="0.00" disabled/> 
                                                    </div>
                                                </div> 
                                            </div>
                                        </li>
                                            ...
                                            <div class="form-group m-0 row">
                                                ...
                                                <div class="col-sm-6 sub-input"> 
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text" style="padding: 6px;" id="basic-addon1">$</span>
                                                        </div> <input class="form-control" type="number" name="hv_avg_annual_asset_loss_per_year_1_per" id="hv_avg_annual_asset_loss_per_year_1_per" ng-model="hv_avg_annual_asset_loss_per_year_1_per" placeholder="0.00" disabled/> 
                                                    </div> 
                                                </div>
                                            </div>
                                        </li>
                                ...
                                <div class="col-md-4 same_box">
                                    <ul class="price">
                                        <li class="header2" ><strong>Average Asset Loss Reduction**</strong>
                                        </li>
                                            ...
                                            <div class="form-group m-0 row">
                                                ...
                                                <div class="col-sm-6 sub-input"> 
                                                    <div class="input-group">
                                                        ...
                                                        <input class="form-control" type="number" placeholder="0.00" name="lr_avg_asset_cost" id="lr_avg_asset_cost" ng-model="lr_avg_asset_cost" ng-change="AssetLossReduction()" required="true" /> 
                                                    </div> 
                                                </div>
                                            </div>
                                        </li>
                                            ...
                                            <div class="form-group m-0 row">
                                                ...
                                                <div class="col-sm-6 sub-input"> 
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text" style="padding: 6px;" id="basic-addon1">$</span>
                                                        </div>  <input class="form-control" type="number" name="lr_total_asset_value" id="lr_total_asset_value" ng-model="lr_total_asset_value" placeholder="0.00"  disabled />  </div> 
                                                </div>
                                            </div>
                                        </li>
                                        <li> 
                                            ...
                                            <div class="form-group m-0 row">
                                                ...
                                                <div class="col-sm-6 sub-input"> 
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text" style="padding: 6px;" id="basic-addon1">$</span>
                                                        </div>  <input class="form-control" type="number" name="lr_avg_annual_asset_loss_per_year" id="lr_avg_annual_asset_loss_per_year" ng-model="lr_avg_annual_asset_loss_per_year" placeholder="0.00"  disabled />  </div> 
                                                </div> 
                                            </div>
                                        </li>
                                        <li> 
                                            <div class="form-group m-0 row">
                                                ...
                                                <div class="col-sm-6 sub-input"> 
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text" style="padding: 6px;" id="basic-addon1">$</span>
                                                        </div>  <input class="form-control" type="number" name="lr_avg_annual_asset_loss_per_year_1_per" id="lr_avg_annual_asset_loss_per_year_1_per" ng-model="lr_avg_annual_asset_loss_per_year_1_per" placeholder="0.00"  disabled />  </div> 
                                                </div>
                                            </div>
                                        </li>
                                        <li><p>** Based on available Market Data Ave. Loss is 10-30%</p></li>                        
                                ...
                                <div class="col-md-4 same_box">
                                    <ul class="price">
                                        <li class="header2"><strong>Search Time Loss Profile Value</strong></li>
                                            ...
                                            <div class="form-group m-0 row">
                                                ...
                                                <div class="col-sm-6 sub-input"> 
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text" style="padding: 6px;" id="basic-addon1">$</span>
                                                        </div>  <input class="form-control" type="number" placeholder="0.00" name="stlp_emp_avg_hourly_rate" ng-model="stlp_emp_avg_hourly_rate" id="stlp_emp_avg_hourly_rate" required="true" ng-change="SearchTimeLossProfile()" /> </div> 
                                                </div> </div>
                                        </li> 
                                        <li> 
                                            <div class="form-group m-0 row">
                                        ...
                                        <li> 
                                            <div class="form-group m-0 row">
                                                ...
                                                <div class="col-sm-6 sub-input"> <input class="form-control" type="number" name="stlp_daily_time_spent_hrs" id="stlp_daily_time_spent_hrs" ng-model="stlp_daily_time_spent_hrs" required="true" ng-change="SearchTimeLossProfile()" min="0" step="0.01"/> </div> 
                                            </div>
                                        </li>
                                        <li>
                                            <div class="form-group m-0 row"> 
                                            ...
                                            <div class="form-group m-0 row">
                                                ...
                                                <div class="col-sm-6 sub-input"> 
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text" style="padding: 6px;" id="basic-addon1">$</span>
                                                        </div>  <input class="form-control" type="number" name="stlp_annual_productivity_lost" id="stlp_annual_productivity_lost" ng-model="stlp_annual_productivity_lost" placeholder="0.00" disabled /> </div> 
                                                </div></div>
                                        </li>
                            ...
                            <div class="row row-eq-height">
                                <div class="col-md-4 same_box">
                                    <ul class="price">
                                        <li class="header2"><strong>Asset Utilization Impact Value</strong></li>
                                            ...
                                            <div class="form-group m-0 row">
                                                ...
                                                <div class="col-sm-6 sub-input"> 
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text" style="padding: 6px;" id="basic-addon1">$</span>
                                                        </div>  <input class="form-control" type="number" name="au_asset_revenue_day" id="au_asset_revenue_day" ng-model="au_asset_revenue_day" placeholder="0.00" required="true" ng-change="AssetUtilization()" /> </div> </div>
                                        </li>
                                        <li> 
                                            <div class="form-group m-0 row">
                                                <label for="au_total_asset" class="col-sm-6 col-form-label">Total No. of Tracked Assets<span class="text-danger">*</span></label>
                                                <div class="col-sm-6 sub-input"> <input class="form-control" type="number" name="au_total_asset" id="au_total_asset" required="true" ng-model="au_total_asset" value="{{hv_total_asset + lr_total_asset}}" ng-change="AssetUtilization()" readonly /> </div> 
                                            </div>
                                        </li>
                                            ...
                                            <div class="form-group m-0 row">
                                                ...
                                                <div class="col-sm-6 sub-input"> 
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text" style="padding: 6px;" id="basic-addon1">$</span>
                                                        </div>  <input class="form-control" type="number" name="au_daily_asset_value" id="au_daily_asset_value" ng-model="au_daily_asset_value" placeholder="0.00" disabled />  </div> </div>
                                            </div>
                                        </li>
                                        <li> 
                                            <div class="form-group m-0 row">
                                            ...
                                            <div class="form-group m-0 row">
                                                ...
                                                <div class="col-sm-6 sub-input"> 
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text" style="padding: 6px;" id="basic-addon1">$</span>
                                                        </div> <input class="form-control" type="number" name="au_daily_asset_revenue_day" id="au_daily_asset_revenue_day" ng-model="au_daily_asset_revenue_day" placeholder="0.00" disabled /> </div> </div>
                                            </div>
                                        </li>
                                        <li> 
                                            <div class="form-group m-0 row">
                                                ...
                                                <div class="col-sm-6 sub-input"> 
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text" style="padding: 6px;" id="basic-addon1">$</span>
                                                        </div>  <input class="form-control" type="number" name="au_daily_asset_revenue_year" id="au_daily_asset_revenue_year" ng-model="au_daily_asset_revenue_year" placeholder="0.00" disabled /> </div> </div>
                                            </div>
                                        </li>
                                        <li> 
                                            <div class="form-group m-0 row">
                                                ...
                                                <div class="col-sm-6 sub-input"> 
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text" style="padding: 6px;" id="basic-addon1">$</span>
                                                        </div> <input class="form-control" type="number" name="au_daily_asset_revenue_year_1_per" id="au_daily_asset_revenue_year_1_per" ng-model="au_daily_asset_revenue_year_1_per" placeholder="0.00" disabled /> </div> </div>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                                <div class="col-md-4 same_box">
                                    <ul class="price">
                                        <li class="header2"><strong>Annual Lost Asset Replacement Value</strong></li>
                                            ...
                                            <div class="form-group m-0 row">
                                                ...
                                                <div class="col-sm-6 sub-input"> 
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text" style="padding: 6px;" id="basic-addon1">$</span>
                                                        </div>  <input class="form-control" type="number" placeholder="0.00" name="alar_total_lost_asset_value" id="alar_total_lost_asset_value" ng-model="alar_total_lost_asset_value" disabled/> </div> </div>
                                            </div>
                                        </li>
                                        <li> 
                                            <div class="form-group m-0 row">
                                            ...
                                            <div class="form-group m-0 row">
                                                ...
                                                <div class="col-sm-6 sub-input"> 
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text" style="padding: 6px;" id="basic-addon1">$</span>
                                                        </div>  <input class="form-control" type="number" name="alar_avg_lost_value" id="alar_avg_lost_value" ng-model="alar_avg_lost_value" placeholder="0.00" disabled />  </div> </div>
                                            </div>
                                        </li>
                                        <li> 
                                            <div class="form-group m-0 row">
                                            ...
                                            <div class="form-group m-0 row">
                                                ...
                                                <div class="col-sm-6 sub-input"> 
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text" style="padding: 6px;" id="basic-addon1">$</span>
                                                        </div>  <input class="form-control" type="number" name="alar_replacement_cost_year" id="alar_replacement_cost_year" ng-model="alar_replacement_cost_year" placeholder="0.00" disabled /> </div> </div>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="col-md-4 same_box">
                                    <ul class="price">
                                        <li class="header2"><strong>Annual Lost Asset Revenue Loss</strong></li>
                                            ...
                                            <div class="form-group m-0 row">
                                                ...
                                                <div class="col-sm-6 sub-input"> 
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text" style="padding: 6px;" id="basic-addon1">$</span>
                                                        </div>  <input class="form-control" type="number" name="alarl_asset_revenue" id="alarl_asset_revenue" ng-model="alarl_asset_revenue" placeholder="0.00" disabled/> </div> </div>
                                            </div>
                                        </li>
                                        <li> 
                                            <div class="form-group m-0 row">
                                            ...
                                            <div class="form-group m-0 row">
                                                ...
                                                <div class="col-sm-6 sub-input"> 
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text" style="padding: 6px;" id="basic-addon1">$</span>
                                                        </div>  <input class="form-control" type="number" name="alarl_total_asset_value" id="alarl_total_asset_value" ng-model="alarl_total_asset_value" placeholder="0.00"  disabled />  </div> </div>
                                            </div>
                                        </li>
                                        <li> 
                                            <div class="form-group m-0 row">
                                            ...
                                            <div class="form-group m-0 row">
                                                ...
                                                <div class="col-sm-6 sub-input"> 
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text" style="padding: 6px;" id="basic-addon1">$</span>
                                                        </div>  <input class="form-control" type="number" name="alarl_asset_revenue_day" id="alarl_asset_revenue_day" ng-model="alarl_asset_revenue_day" placeholder="0.00" disabled /> </div> </div>
                                            </div>
                                        </li>
                                        <li> 
                                            <div class="form-group m-0 row">
                                                ...
                                                <div class="col-sm-6 sub-input"> 
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text" style="padding: 6px;" id="basic-addon1">$</span>
                                                        </div>  <input class="form-control" type="number" name="alarl_asset_revenue_loss_year" id="alarl_asset_revenue_loss_year" ng-model="alarl_asset_revenue_loss_year" placeholder="0.00" disabled /> </div> </div>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 p-0">
                                    <ul class="price">
                                        <li class="header" >Pycube Annualized ROI & Expected TCO Cost Reduction Minimum Delivery Value
                                        </li>
                                            ...
                                            <div class="form-group m-0 row">
                                                ...
                                                <div class="col-sm-6 sub-input"> 
                                                    <div class="input-group">
                                                        ...
                                                        <input class="form-control" type="number" name="hv_loss_reduction" id="hv_loss_reduction" placeholder="" ng-model="hv_loss_reduction" disabled/> </div>
                                                </div> 
                                            </div>
                                        </li>
                                        <li> 
                                            <div class="form-group m-0 row">
                                                ...
                                                <div class="col-sm-6 sub-input"> 
                                                    <div class="input-group">
                                                        ...
                                                        <input class="form-control" type="number" name="avg_asset_loss_reduction" id="avg_asset_loss_reduction" ng-model="avg_asset_loss_reduction" disabled/> </div> </div>
                                            </div>
                                        </li>
                                        <li> 
                                            <div class="form-group m-0 row">
                                                ...
                                                <div class="col-sm-6 sub-input">
                                                    <div class="input-group">
                                                        ...
                                                        <input class="form-control" type="number" name="avg_replacement_lost_asset" id="avg_replacement_lost_asset" ng-model="avg_replacement_lost_asset" disabled/> </div> </div>
                                            </div>
                                        </li>
                                        <li> 
                                            <div class="form-group m-0 row">
                                                ...
                                                <div class="col-sm-6 sub-input"> 
                                                    <div class="input-group">
                                                        ...
                                                        <input class="form-control" type="number" name="reduction_staff_search_time" id="reduction_staff_search_time" ng-model="reduction_staff_search_time" disabled />  </div> </div>
                                            </div>
                                        </li>
                                        <li> 
                                            <div class="form-group m-0 row">
                                                ...
                                                <div class="col-sm-6 sub-input">
                                                    <div class="input-group">
                                                        ...
                                                        <input class="form-control" type="number" name="increase_asset_utilization" id="increase_asset_utilization" ng-model="increase_asset_utilization"  disabled />  </div> </div>
                                            </div>
                                        </li>
                                            ...
                                            <div class="form-group m-0 row">
                                                ...
                                                <div class="col-sm-6 sub-input">
                                                    <div class="input-group">
                                                        ...
                                                        <input class="form-control" type="number" name="decrease_lost_asset_revenue" id="decrease_lost_asset_revenue" ng-model="decrease_lost_asset_revenue" disabled />  </div> </div>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                                            ...
                                            <div class="form-group m-0 row">
                                                ...
                                                <div class="col-sm-6 sub-input">
                                                    <div class="input-group">
                                                        ...
                                                        <input class="form-control" type="number" name="cost_reduction_value_year" id="cost_reduction_value_year" ng-model="cost_reduction_value_year" disabled />  </div> </div>
                                            </div>
                                        </li>
                                        <li> 
                                            <div class="form-group m-0 row">
                                                ...
                                                <div class="col-sm-6 sub-input">
                                                    <div class="input-group">
                                                        ...
                                                        <input class="form-control" type="number" name="cost_reduction_value_3_year" id="cost_reduction_value_3_year" ng-model="cost_reduction_value_3_year"  disabled />  </div> </div>
                                            </div>
                                        </li>
                                        <li> 
                                            <div class="form-group m-0 row">
                                                ...
                                                <div class="col-sm-6 sub-input">
                                                    <div class="input-group">
                                                        ...
                                                        <input class="form-control" type="number" name="cost_reduction_value_5_year" id="cost_reduction_value_5_year" ng-model="cost_reduction_value_5_year" disabled />  </div> </div>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                    ...
                    <div class="row m-0">
                        ...
                        <div class="col-sm-2 sub-text pull-left " style="padding-bottom:10px;">
                            <button type="reset" name="roi_submit" class="btn btn-block  btn-default btn-secondary">Clear</button>
                        </div>
                        <div class="col-sm-2 sub-text pull-right " style="padding-bottom:10px;">
                            <button type="submit" name="roi_submit" class="btn btn-block btn-default btn-primary">Send me a copy</button>
                        </div>
                        <div class="col-sm-4 sub-text pull-right " style="padding-bottom:10px;"></div>
                    </div>
                </form>
        ...
        <!-- Modal -->    
        <div class="modal fade" id="roiModal" tabindex="-1" role="dialog" aria-labelledby="roiModalLabel" aria-hidden="true">
