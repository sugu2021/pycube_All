...
<div class="modal fade" id="loadmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content" style="border: none !important;box-shadow: 0 3px 7px rgba(0, 0, 0, 0.3) !important;">
        <div class="modal-body" style="background: #56BDE7;">
            <div class="row">
                <div class="col-sm-12">
                   <!--  <button type="button" class="close custom_modal_close" data-dismiss="modal" aria-label="Close">
                    ...
                    <div class="main_modal_content">
                        <img style="position: absolute;top: -10px;" src="img/dots.png">
                        <div class="text-center">    
                         <img style="max-width: 240px;padding: 27px 0px 15px;" src="img/himss20-purple.png">
                     </div>
                     <!-- <h2>Please Meet us on Himss</h2> -->
                     <h5>MARCH 9-13, 2020 <span>.</span> ORLANDO, FL</h5>
                     <div class="text-center">
                        <img style="max-width: 190px;margin: 5px 0px 18px;" src="img/logo.png">
                    </div>
                    <p style="color: #fff;font-weight: 500;text-align: center;font-size: 18px;">Visit us at the Intelligent Health Pavilion #7273-33</p>
                    <div style="text-align: center;margin-bottom: 10px;">
                      <a href="contact.php"><button class="btn custom_register_btn"  >Schedule a Meeting</button></a>
                      <button type="button" class="btn-link" data-dismiss="modal" aria-label="Close" style="display: block;z-index: 9;position: relative;margin: 8px auto 0px;border: none;color: #fff;cursor: pointer;">
                        <span aria-hidden="true" style="font-size: 14px;">Close</span>
                    </button>
                  </div>
              </div>
          </div>
  ...
  <div class="modal-footer" style="border: none;padding: 0px;">
      <img style="width: 100%;position: absolute;margin-top: -27px;;" src="img/modal-footer.png">
  </div>
</div>
</div>
</div>
